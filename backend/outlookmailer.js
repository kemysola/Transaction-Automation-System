...
//  async function sendConfirmationEmailOutlook(email, confirmationCode, otp, username) {
  async function sendConfirmationEmailOutlook(email, confirmationCode, otp, username) {
...
let info =  await transporter.sendMail({
  ...
  to: email,
  subject: "Welcome To TRMS ✔", // Subject line
  html: `<head>
                                  ...
                                  <div
                                    ...
                                    <p
                                      ...
                                      <span style="font-size:16px;">Please confirm
                                        ...
                                        link <a
                                          href=https://trms01-server.azurewebsites.net/api/v1/staff/confirm/${confirmationCode}>
                                          Click here</a> </span></p>
...
module.exports.sendConfirmationEmailOutlook = sendConfirmationEmailOutlook;
