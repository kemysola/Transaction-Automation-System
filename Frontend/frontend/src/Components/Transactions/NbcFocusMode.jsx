...
const NBCFocus = ((props) => {
  ...
  function handleSubmit(e) {
    ...
    console.log(props.id, props.transid, nbcFocusOriginal, nbcFocusOriginalYesNo, nbcFocusOriginalDate, nbcFocusOriginalMethod);
    ...
    setnbcFocusOriginal();
    setnbcFocusOriginalYesNo();
    setnbcFocusOriginalDate();
    setnbcFocusOriginalMethod();
    setEditing(false);
  }
